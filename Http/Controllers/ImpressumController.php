...
namespace App\Modules\Impressum\Http\Controllers;
...
class ImpressumController extends Controller
{
    ...
    {
        //Audit::log(Auth::user()->id, trans('impressum::general.audit-log.category'), trans('impressum::general.audit-log.msg-index'));
